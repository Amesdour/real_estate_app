  ...
  const properties = [
    {
      ...
      bathrooms: 2,
      areaSqm: 210,
      amenities: ["POOL", "GARDEN", "GARAGE", "SECURITY"] as const,
    ...
    },
    {
      ...
      listingKind: "RENT" as const,
      price: 45000,
      reservationFee: 20000,
      bedrooms: 2,
      bathrooms: 1,
      areaSqm: 85,
      amenities: ["FURNISHED", "AIR_CONDITIONING", "ELEVATOR"] as const,
